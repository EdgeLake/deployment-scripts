#----------------------------------------------------------------------------------------------------------------------#
# The following provides pulling the Smart City power-plant data into a single table called pp_pm
# :sample data:
# {
#    "monitor_id":"BSP",
...
# }
#----------------------------------------------------------------------------------------------------------------------#
# process !anylog_path/deployment-scripts/customers/smart-city/msg_client_powerplant_table_pp_pm.al
...
<run msg client where
    ...
    topic=(
        ...
        table=pp_pm and
        column.monitor_id.str="bring [monitor_id]" and
