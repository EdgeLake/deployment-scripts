...
#   --> sync from contract
#----------------------------------------------------------------------------------------------------------------------#
# process !anylog_path/deployment-scripts/node-deployment/connect_blockchain.al
...
do process !anylog_path/deployment-scripts/node-deployment/policies/blockchain_policy.al
do get platforms
