...
#video_host = !ip
#if not !video_host then video_host = 0.0.0.0
#set default_dbms = test
#print "video_ai.al: Setting up video display (imshow) port " + !video_port
...
#print "video_ai.al: Done - view at http://localhost:" + !video_port + "/stream/" + !video_name
#goto end-script
#
#:end-script:
#end script
