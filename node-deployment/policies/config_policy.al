...
<do set policy new_policy [config][script] = [
    ...
    "run scheduler 1",
    "if !monitor_nodes == true then process !anylog_path/deployment-scripts/sample-scripts/monitoring_policy.al",
...
<set policy new_policy [config][script] = [
    ...
    "if !enable_opcua == true then process !anylog_path/deployment-scripts/sample-scripts/opcua_client.al",
    ...
    "if !syslog_monitoring == true then process !anylog_path/deployment-scripts/sample-scripts/syslog.al",
    "if !deploy_local_script == true then process !local_scripts/local_script.al",
    "if !is_edgelake == false then process !local_scripts/policies/license_policy.al"
]>
goto publish-policy
