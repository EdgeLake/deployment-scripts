...
else if !enable_dns == true then set policy new_policy [config][local_ip] = '!dns'
...
else if !rest_bind == true and !enable_dns == true   then set policy new_policy [config][rest_ip] = '!dns'
...
else if !broker_bind == true and !enable_dns == true   then set policy new_policy [config][broker_ip] = '!dns'
