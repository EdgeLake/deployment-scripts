...
else if !rest_bind == true and !use_local_dns == true then set policy new_policy [config][rest_ip] = '!dns'
...
else if !broker_bind == true and !use_local_dns == true then set policy new_policy [config][broker_ip] = '!dns'
